    ...
    $.fn.formset = function(opts)
    {
        ...
        if ($$.length) {
            ...
            if ($$.attr('tagName') == 'TR') {
                ...
                var styleHide = '';
                var formLength = parseInt($('#id_form-TOTAL_FORMS').val());
                if (formLength >= options.maxList) { styleHide = ' style="display:none;"' }
                $$.parent().append('<tr><td colspan="' + numCols + '"><a class="' + options.addCssClass + '" href="javascript:void(0)"' + styleHide + '>' + options.addText + '</a></tr>');
                ...
                var formLength = parseInt($('#id_form-TOTAL_FORMS').val());
                if (formLength >= options.maxList) { styleHide = ' style="display:none;"' }
                $$.filter(':last').after('<a class="' + options.addCssClass + '" href="javascript:void(0)"' + styleHide + '>' + options.addText + '</a>');
