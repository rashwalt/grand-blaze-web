...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Skill.sk_sp_fire'
        db.delete_column('skill_skill', 'sk_sp_fire')

        # Deleting field 'Skill.sk_sp_bash'
        db.delete_column('skill_skill', 'sk_sp_bash')

        # Deleting field 'Skill.sk_sp_conv'
        db.delete_column('skill_skill', 'sk_sp_conv')

        # Deleting field 'Skill.sk_sp_scream'
        db.delete_column('skill_skill', 'sk_sp_scream')

        # Deleting field 'Skill.sk_sp_slash'
        db.delete_column('skill_skill', 'sk_sp_slash')

        # Deleting field 'Skill.sk_sp_hard'
        db.delete_column('skill_skill', 'sk_sp_hard')

        # Deleting field 'Skill.sk_sp_pike'
        db.delete_column('skill_skill', 'sk_sp_pike')

        # Deleting field 'Skill.sk_sp_swing'
        db.delete_column('skill_skill', 'sk_sp_swing')


    def backwards(self, orm):
        
        # Adding field 'Skill.sk_sp_fire'
        db.add_column('skill_skill', 'sk_sp_fire', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Skill.sk_sp_bash'
        db.add_column('skill_skill', 'sk_sp_bash', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Skill.sk_sp_conv'
        db.add_column('skill_skill', 'sk_sp_conv', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Skill.sk_sp_scream'
        db.add_column('skill_skill', 'sk_sp_scream', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Skill.sk_sp_slash'
        db.add_column('skill_skill', 'sk_sp_slash', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Skill.sk_sp_hard'
        db.add_column('skill_skill', 'sk_sp_hard', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Skill.sk_sp_pike'
        db.add_column('skill_skill', 'sk_sp_pike', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Skill.sk_sp_swing'
        db.add_column('skill_skill', 'sk_sp_swing', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 17, 2, 3, 33, 77000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 17, 2, 3, 33, 77000)'}),
