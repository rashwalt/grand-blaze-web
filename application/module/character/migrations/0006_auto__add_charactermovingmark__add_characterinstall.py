...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CharacterMovingMark'
        db.create_table('character_charactermovingmark', (
            ...
            ('instance', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('character', ['CharacterMovingMark'])

        # Adding model 'CharacterInstall'
        db.create_table('character_characterinstall', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('install_id', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('level', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('exp', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('character', ['CharacterInstall'])


    def backwards(self, orm):
        
        # Deleting model 'CharacterMovingMark'
        db.delete_table('character_charactermovingmark')

        # Deleting model 'CharacterInstall'
        db.delete_table('character_characterinstall')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 22, 0, 45, 34, 960000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 22, 0, 45, 34, 960000)'}),
        ...
        'character.character': {
            ...
            'last_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 22, 0, 45, 34, 876000)'}),
