...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CharacterQuest'
        db.create_table('character_characterquest', (
            ...
            ('clear_fg', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('step', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('character', ['CharacterQuest'])


    def backwards(self, orm):
        
        # Deleting model 'CharacterQuest'
        db.delete_table('character_characterquest')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 21, 20, 46, 35, 403000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 21, 20, 46, 35, 403000)'}),
        ...
        'character.character': {
            ...
            'last_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 21, 20, 46, 35, 337000)'}),
