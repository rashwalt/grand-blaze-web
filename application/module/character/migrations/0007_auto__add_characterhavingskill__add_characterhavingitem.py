...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CharacterHavingSkill'
        db.create_table('character_characterhavingskill', (
            ...
            ('sc_flg', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('character', ['CharacterHavingSkill'])

        # Adding model 'CharacterHavingItem'
        db.create_table('character_characterhavingitem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('box_type', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('have_no', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('item_id', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('it_box_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('it_box_baz_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('equip_spot', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('is_new', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('created', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('it_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('it_comment', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('it_effect', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('it_price', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=13, decimal_places=1, blank=True)),
            ('it_seller', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=13, decimal_places=1, blank=True)),
        ))
        db.send_create_signal('character', ['CharacterHavingItem'])


    def backwards(self, orm):
        
        # Deleting model 'CharacterHavingSkill'
        db.delete_table('character_characterhavingskill')

        # Deleting model 'CharacterHavingItem'
        db.delete_table('character_characterhavingitem')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 27, 1, 25, 25, 672000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 27, 1, 25, 25, 672000)'}),
        ...
        'character.character': {
            ...
            'last_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 27, 1, 25, 25, 540000)'}),
