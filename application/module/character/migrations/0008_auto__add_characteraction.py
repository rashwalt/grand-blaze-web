...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CharacterAction'
        db.create_table('character_characteraction', (
            ...
            ('action_target', self.gf('django.db.models.fields.IntegerField')()),
        ...
        db.send_create_signal('character', ['CharacterAction'])


    def backwards(self, orm):
        
        # Deleting model 'CharacterAction'
        db.delete_table('character_characteraction')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 27, 1, 40, 23, 366000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 27, 1, 40, 23, 366000)'}),
        ...
        'character.character': {
            ...
            'last_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 27, 1, 40, 23, 239000)'}),
