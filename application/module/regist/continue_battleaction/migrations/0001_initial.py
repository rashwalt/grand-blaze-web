...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ContinueBattleAction'
        db.create_table('continue_battleaction_continuebattleaction', (
            ...
            ('action_no', self.gf('django.db.models.fields.IntegerField')(default=1, blank=True)),
            ('action_target', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ...
        db.send_create_signal('continue_battleaction', ['ContinueBattleAction'])


    def backwards(self, orm):
        
        # Deleting model 'ContinueBattleAction'
        db.delete_table('continue_battleaction_continuebattleaction')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 26, 21, 0, 31, 425000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 26, 21, 0, 31, 425000)'}),
        ...
        'continue_battleaction.continuebattleaction': {
            'Meta': {'object_name': 'ContinueBattleAction'},
            'action': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'action_no': ('django.db.models.fields.IntegerField', [], {'default': '1', 'blank': 'True'}),
            'action_target': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
    ...
    complete_apps = ['continue_battleaction']
