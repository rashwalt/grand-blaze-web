...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ContinueSerif'
        db.create_table('continue_serif_continueserif', (
        ...
        db.send_create_signal('continue_serif', ['ContinueSerif'])


    def backwards(self, orm):
        
        # Deleting model 'ContinueSerif'
        db.delete_table('continue_serif_continueserif')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 4, 16, 15, 55, 598986)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 4, 16, 15, 55, 598870)'}),
