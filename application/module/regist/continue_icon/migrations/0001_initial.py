...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ContinueIcon'
        db.create_table('continue_icon_continueicon', (
        ...
        db.send_create_signal('continue_icon', ['ContinueIcon'])


    def backwards(self, orm):
        
        # Deleting model 'ContinueIcon'
        db.delete_table('continue_icon_continueicon')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 4, 0, 49, 10, 330000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 4, 0, 49, 10, 330000)'}),
        ...
        'continue_icon.continueicon': {
            'Meta': {'object_name': 'ContinueIcon'},
