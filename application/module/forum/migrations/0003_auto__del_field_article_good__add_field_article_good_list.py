...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Article.good_list'
        db.add_column('forum_article', 'good_list',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Article.good_list'
        db.delete_column('forum_article', 'good_list')
    ...
    models = {
        'forum.article': {
            ...
            'edit_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 12, 0, 0)'}),
        ...
        'forum.thread': {
            ...
            'last_article_update_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 12, 0, 0)'}),
