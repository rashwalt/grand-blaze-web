...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Thread.status_change_pass'
        db.add_column('forum_thread', 'status_change_pass',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Thread.status_change_pass'
        db.delete_column('forum_thread', 'status_change_pass')
    ...
    models = {
        ...
        'forum.thread': {
            ...
            'status_change_pass': ('django.db.models.fields.CharField', [], {'max_length': '16', 'null': 'True', 'blank': 'True'}),
