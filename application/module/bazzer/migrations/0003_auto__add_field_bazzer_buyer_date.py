...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bazzer.buyer_date'
        db.add_column('bazzer_bazzer', 'buyer_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bazzer.buyer_date'
        db.delete_column('bazzer_bazzer', 'buyer_date')
    ...
    models = {
        ...
        'bazzer.bazzer': {
            ...
            'buyer_date': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            ...
            'seller_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 18, 0, 0)'}),
            'seller_having_no': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
