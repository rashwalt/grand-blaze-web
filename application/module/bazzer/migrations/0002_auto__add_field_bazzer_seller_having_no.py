...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bazzer.seller_having_no'
        db.add_column('bazzer_bazzer', 'seller_having_no',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bazzer.seller_having_no'
        db.delete_column('bazzer_bazzer', 'seller_having_no')
