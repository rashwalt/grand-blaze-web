...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bazzer.done'
        db.add_column('bazzer_bazzer', 'done',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bazzer.done'
        db.delete_column('bazzer_bazzer', 'done')
    ...
    models = {
        ...
        'bazzer.bazzer': {
            ...
            'seller_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 17, 0, 0)'}),
